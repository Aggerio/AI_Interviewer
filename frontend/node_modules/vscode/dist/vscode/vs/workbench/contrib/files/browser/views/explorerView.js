...
let ExplorerView = class ExplorerView extends ViewPane {
    ...
    storeTreeViewState() {
        this.storageService.store(ExplorerView.TREE_VIEW_STATE_STORAGE_KEY, JSON.stringify(this.tree.getViewState()), 1 , 1 );
    }
    setContextKeys(stat) {
    ...
    async setTreeInput() {
        ...
        if (this.tree && this.tree.getInput()) {
            ...
            const rawViewState = this.storageService.get(ExplorerView.TREE_VIEW_STATE_STORAGE_KEY, 1 );
            if (rawViewState) {
...
export { ExplorerView, getContext };
