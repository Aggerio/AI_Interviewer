...
import { AbstractGotoSymbolQuickAccessProvider } from 'monaco-editor/esm/vs/editor/contrib/quickAccess/browser/gotoSymbolQuickAccess.js';
import { IConfigurationService } from 'monaco-editor/esm/vs/platform/configuration/common/configuration.js';
import { Disposable, toDisposable, DisposableStore, MutableDisposable } from 'monaco-editor/esm/vs/base/common/lifecycle.js';
...
import { prepareQuery } from 'monaco-editor/esm/vs/base/common/fuzzyScorer.js';
import { fuzzyScore, createMatches } from 'monaco-editor/esm/vs/base/common/filters.js';
import { onUnexpectedError } from 'monaco-editor/esm/vs/base/common/errors.js';
import { IOutlineService } from '../../../../services/outline/browser/outline.js';
import { isCompositeEditor } from 'monaco-editor/esm/vs/editor/browser/editorBrowser.js';
        ...
        this.outlineService.createOutline(pane, 4 , cts.token).then(outline => {
            ...
            const updatePickerItems = () => {
                const filteredItems = items.filter(item => {
                    ...
                    const score = fuzzyScore(picker.value, picker.value.toLowerCase(), 1 , item.label, item.label.toLowerCase(), 0, { firstMatchCanBeWeak: true, boostFullMatch: true });
                    if (!score) {
                        return false;
                    }
                    item.score = score[1];
