...
const MainContext = {
    ...
    MainThreadSemanticSimilarity: ( createProxyIdentifier('MainThreadSemanticSimilarity')),
...
const ExtHostContext = {
    ...
    ExtHostSemanticSimilarity: ( createProxyIdentifier('ExtHostSemanticSimilarity')),
...
export { CandidatePortSource, ExtHostContext, IdObject, MainContext, NotebookEditorRevealType, TextEditorRevealType };
