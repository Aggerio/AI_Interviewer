...
import { Disposable, DisposableMap, combinedDisposable, toDisposable } from 'monaco-editor/esm/vs/base/common/lifecycle.js';
...
import { CallHierarchyProviderRegistry } from '../../contrib/callHierarchy/common/callHierarchy.js';
import { WorkspaceSymbolProviderRegistry } from '../../contrib/search/common/search.js';
import { TypeHierarchyProviderRegistry } from '../../contrib/typeHierarchy/common/typeHierarchy.js';
...
let MainThreadPasteEditProvider = class MainThreadPasteEditProvider {
    constructor(handle, _proxy, metadata, _uriIdentService) {
        this.handle = handle;
        this._proxy = _proxy;
        this._uriIdentService = _uriIdentService;
...
let MainThreadDocumentOnDropEditProvider = class MainThreadDocumentOnDropEditProvider {
    constructor(handle, metadata, _proxy, _uriIdentService) {
        this.handle = handle;
        this._proxy = _proxy;
        this._uriIdentService = _uriIdentService;
        this.dataTransfers = ( new DataTransferFileCache());
