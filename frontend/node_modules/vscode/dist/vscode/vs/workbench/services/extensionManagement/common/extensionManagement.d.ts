...
import { IExtensionManifest, IExtension } from '../../../../platform/extensions/common/extensions.js';
import { InstallExtensionResult, InstallVSIXOptions, ILocalExtension, IGalleryExtension, InstallOptions, IExtensionManagementService, InstallExtensionEvent, UninstallExtensionEvent, DidUninstallExtensionEvent } from '../../../../platform/extensionManagement/common/extensionManagement.js';
...
export { DidChangeProfileEvent, DidChangeProfileForServerEvent, DidUninstallExtensionOnServerEvent, EnablementState, IExtensionManagementServer, IProfileAwareExtensionManagementService, IWorkbenchExtensionEnablementService, IWorkbenchExtensionManagementService, InstallExtensionOnServerEvent, UninstallExtensionOnServerEvent };
