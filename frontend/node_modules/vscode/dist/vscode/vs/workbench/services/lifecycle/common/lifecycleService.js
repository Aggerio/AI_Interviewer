    ...
    constructor(logService, storageService) {
        ...
        this.storageService.onWillSaveState(e => {
            if (e.reason === WillSaveStateReason.SHUTDOWN) {
                this.storageService.store(AbstractLifecycleService.LAST_SHUTDOWN_REASON_KEY, this.shutdownReason, 1 , 1 );
            }
        });
    }
    resolveStartupKind() {
        const lastShutdownReason = this.storageService.getNumber(AbstractLifecycleService.LAST_SHUTDOWN_REASON_KEY, 1 );
        this.storageService.remove(AbstractLifecycleService.LAST_SHUTDOWN_REASON_KEY, 1 );
        let startupKind;
