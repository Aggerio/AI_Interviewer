...
export { ACTIVE_GROUP, ACTIVE_GROUP_TYPE, IBaseSaveRevertAllEditorOptions, IEditorService, IEditorsChangeEvent, IOpenEditorsOptions, IRevertAllEditorsOptions, ISaveAllEditorsOptions, ISaveEditorsOptions, ISaveEditorsResult, IUntypedEditorReplacement, PreferredGroup, SIDE_GROUP, SIDE_GROUP_TYPE };
