...
declare const enum ExtensionRunningPreference {
    None = 0,
    Local = 1,
    Remote = 2
}
interface IExtensionHostKindPicker {
...
export { ExtensionHostKind, ExtensionRunningPreference, IExtensionHostKindPicker };
