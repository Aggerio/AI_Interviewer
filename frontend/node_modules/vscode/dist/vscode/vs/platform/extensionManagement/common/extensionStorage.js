...
let ExtensionStorageService = class ExtensionStorageService extends Disposable {
    ...
    setKeysForSync(extensionIdWithVersion, keys) {
        this.storageService.store(ExtensionStorageService.toKey(extensionIdWithVersion), JSON.stringify(keys), 0 , 1 );
    }
    getKeysForSync(extensionIdWithVersion) {
        ...
        const extensionKeysForSyncFromStorageValue = this.storageService.get(ExtensionStorageService.toKey(extensionIdWithVersion), 0 );
