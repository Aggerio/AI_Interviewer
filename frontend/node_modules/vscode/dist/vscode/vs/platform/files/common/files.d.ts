...
export { FileChangeType, FileChangesEvent, FileOperation, FileOperationEvent, FilePermission, FileSystemProviderCapabilities, FileSystemProviderError, FileSystemProviderErrorCode, FileType, IBaseFileStat, IBaseFileStatWithMetadata, IBaseReadFileOptions, ICreateFileOptions, IFileAtomicOptions, IFileAtomicWriteOptions, IFileChange, IFileContent, IFileDeleteOptions, IFileOpenForReadOptions, IFileOpenForWriteOptions, IFileOpenOptions, IFileOperationEvent, IFileOperationEventWithMetadata, IFileOverwriteOptions, IFileReadLimits, IFileReadStreamOptions, IFileService, IFileStat, IFileStatResult, IFileStatWithMetadata, IFileStatWithPartialMetadata, IFileStreamContent, IFileSystemProvider, IFileSystemProviderActivationEvent, IFileSystemProviderCapabilitiesChangeEvent, IFileSystemProviderError, IFileSystemProviderRegistrationEvent, IFileSystemProviderWithFileReadStreamCapability, IFileSystemProviderWithFileReadWriteCapability, IFileUnlockOptions, IFileWriteOptions, IReadFileOptions, IReadFileStreamOptions, IResolveFileOptions, IResolveMetadataFileOptions, IStat, IWatchOptions, IWriteFileOptions };
