...
registerFileUrl('./syntaxes/shaderlab.tmLanguage.json', new URL('./shaderlab/shaderlab.tmLanguage.json', import.meta.url).toString(), 'application/json');

registerFileUrl('./language-configuration.json', new URL('./shaderlab/language-configuration.json', import.meta.url).toString(), 'application/json');
